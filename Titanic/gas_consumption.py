...
data, labels = load_csv('measurements2.csv', target_column=0, columns_to_ignore=[5,7,8,9,10,11], categorical_labels=True, n_classes=1)
...
# print("Amogh's odds of survival: ", model.predict([[1, 0, 16, 2, 0, 80.00]])[0][1])
